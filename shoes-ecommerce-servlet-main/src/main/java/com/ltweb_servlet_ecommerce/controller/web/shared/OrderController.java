    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            for (int i = 0; i < listOrder.size(); i++) {
                ...
                List<OrderDetailsModel> listOrderDetails = orderDetailsService.findAllWithFilter(orderDetailsModel, orderPaging);
                ...
                if (orderModel.getSign() == null) {
                    orderModel.setSign("trống");
                }
